...
#define GPIO_DIRECTION_CNTRL_REG  (GPIO_START + (0 * GPIO_OFFSET ))   // 262400 + (0*8) = 262400 = 0x00040100
#define GPIO_DATA_REG             (GPIO_START + (1 * GPIO_OFFSET ))   // 262400 + (1*8) = 262408 = 0x00040108
#define GPIO_SET_REG              (GPIO_START + (2 * GPIO_OFFSET ))   // 262400 + (2*8) = 262416 = 0x00040110
#define GPIO_CLEAR_REG            (GPIO_START + (3 * GPIO_OFFSET ))   // 262400 + (3*8) = 262424 = 0x00040118
#define GPIO_TOGGLE_REG           (GPIO_START + (4 * GPIO_OFFSET ))   // 262400 + (4*8) = 262432 = 0x00040120
#define GPIO_QUAL_REG             (GPIO_START + (5 * GPIO_OFFSET ))   // 262400 + (5*8) = 262440 = 0x00040128
#define GPIO_INTERRUPT_CONFIG_REG (GPIO_START + (6 * GPIO_OFFSET ))   // 262400 + (6*8) = 262448 = 0x00040130
